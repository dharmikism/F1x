...
chrome.storage?.local?.get(["pendingProblem", "pendingSource"], (data) => { if (data?.pendingProblem) { $("#save-problem").value = data.pendingProblem; showSave(); chrome.storage.local.remove(["pendingProblem", "pendingSource"]); } });
